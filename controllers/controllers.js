...
const insertData = async (req, res) => {
  const { title, rating, quality, description, image } = req.body;
  console.log({ title, rating, quality, description, image });
...
const updateData = async (req, res) => {
  console.log(req.body)
    const { title, rating, quality, description, image, id} = req.body;
    try {
